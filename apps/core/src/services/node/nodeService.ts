import {
  nodeRequestEvent,
  nodeResponseEventMap,
  nodeResponseEventType,
} from './nodeEventTypes';
import nodejs from './nodejs';

// nodejs.start('main.js');
const initializationMessage = (message: unknown) =>
...
export const sendEventToNode = <T extends nodeResponseEventType>(
  event: { type: T } & nodeRequestEvent,
) => {
...
export const sendEventToServer = <T extends { type: 'serverWorker' }>(
  event: T,
) => {
