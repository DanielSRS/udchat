...
//     const headerObject: unknown = JSON.parse(headerString);
...
// const processNewMessage = (msg: Buffer, info: dgram.RemoteInfo) => {
...
//       const encryptedData = Buffer.concat(group.acumulatedParts as Buffer[]).toString('base64');
